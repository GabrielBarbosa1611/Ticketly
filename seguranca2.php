...
<head>
    ...
    <title>Sunset</title>
    <link rel="stylesheet" href="style_seguranca2.css">
</head>
...
<body>
    ...
    <div class="flex-container" id="home">
        <div class="pericles">
            <img src="../Fotos/cyber.png" style="border-radius: 30px !important;"
                class="mx-auto d-block img-fluid evento" width="1000px" height="300px">

        </div>
    </div>

    <div class="titulo-info">
        <h1> Cibersegurança Focada na Indústria 4.0 - 04/12/23</h1>
        <h4> Segunda-Feira às 17h00 | 04 de Dezembro à 07 de Dezembro </h4>
        <h4> INDT(Instituto de Desenvolvimento Tecnológico) - Manaus, AM</h4>
    </div>
    <div class="todas-info principal">
        <div class="col col-esq">
            <div class="info-evento">
                ...
                #DADOSCOMPROMETIDOS 
                <br>
                Durante os dias 4 a 7 de dezembro, você irá aprender sobre como evitar alertas como esse!
                <br>
                <br>
                Serão 20 Horas de imersão intensiva durante 4 Dias de aprendizado com nossos experts de segurança da informação sobre as principais tecnologias para se prevenir de Ciberataques
                <br>
                <br>
                📅 DATA: 04 DE DEZEMBRO À 07 DE DEZEMBRO (SEGUNDA - TERÇA - QUARTA) <br><br>
                ⏰ HORÁRIO: 17H00 <br><br>
                📍 LOCAL: INDT - MANAUS, AM
                <br><br>
                Aproveite agora essa oportunidade única de capacitar o seu time, para aprender com profissionais que lidam com ciberataques todos os dias. Garanta a sua vaga agora mesmo!
                <br>
                <br>
                ...
                <div class="box-ingressos">
                    ...
                    <div class="ingressos">
                        ...
                        <div class="class-indicativa">
                            <p>
                                <!-- NÃO TIRE O P, POIS A BARRA IRÁ FICAR MENOR-->
                            </p>
                        </div>
                    </div>
                    <fieldset>
                        <div class="opcao-ingresso">
                            ...
                            <h2>
                                <span class="caps">PÚBLICO - CIBERSEGURANÇA NA INDUSTRIA 4.0</span>
                            </h2>
                            <p></p>
