...
<head>
    ...
    <title>Sunset</title>
    <link rel="stylesheet" href="style_quandoeuformae2.css">
</head>
...
<body>
    ...
    <div class="flex-container" id="home">
        <div class="pericles">
            <img src="../Fotos/quandoeuformae.png" style="border-radius: 30px !important;"
    ...
    <div class="titulo-info">
        <h1> VERA FISCHER EM - QUANDO EU FOR MÃE, QUERO AMAR DESSE JEITO </h1>
        <h4>Dias 01, 02 e 03 | a partir das 18h00</h4>
        <h4>Teatro Do Parque - Recife, PE</h4>
    </div>
    <div class="todas-info principal">
        <div class="col col-esq">
            <div class="info-evento">
                ...
                <h5>Sobre:</h5>
                VERA FISCHER APRESENTA: "QUANDO EU FOR MÃE, QUEOR AMAR DESSE JEITO"
                <br><br>
                APRESENTAMOS, NOS DIAS 01, 02 3 03 DE SETEMBRO UMA COMÉDIA PRA LÁ DE INUSITADA E CHEIA DE VENENO. COM DIREÇÃO DE TADEU AGUIAR, E PARTICIPAÇÃO DE MARTA PARET E RAFAEL SARDÃO, PODEMOS AGUARDAR MUITA COMÉDIA BOA E ENTRETENIMENTO!
                <br><br>
                📅 DATA: 01, 02 e 03 DE SETEMBRO DE 2023 (SEXTA-FEIRA/ SÁBADO/ DOMINGO)<br><br>
                ⏰ HORÁRIO: A PARTIR DAS 18H00<br><br>
                📍 LOCAL: TEATRO DO PARQUE (AVENIDA BOA VAIGEM, 551 -  RECIFE, PE) 
                <br><br>
                A PEÇA "QUANDO EU FOR MÃE, QUERO AMAR DESSE JEITO" PROMETE ENVOLVER O PÚBLICO COM POUCAS E BOAS RISADAS, O QUE É DE SE ESPERAR DE UMA DAS ATRIZES MAIS ICÔNICAS E APLAUDIDAS DO NOSSO PÁIS. FICOU CURIOSO? VEM LOGO CONFERIR!
                <BR><BR>
                GARANTA SEU LUGAR NESSA FESTA INCRÍVEL! INGRESSOS JÁ À VENDA EM NOSSO SITE OU NOS PONTOS AUTORIZADOS.
                <br><br>
                PREPARE-SE PARA VIVER MOMENTOS INESQUECÍVEIS! MARQUE NA AGENDA E CONVIDE SEUS AMIGOS PARA ESSA NOITE CHEIA DE BOBAGEM E DIVERSÃO. ESPERAMOS POR VOCÊ!
                <br><br>
                    ...
                    <fieldset>
                        <div class="opcao-ingresso">
                            ...
                            <h2>
                                <span class="caps">MEIA</span>
                                <br>
                                Mediante comprovação de meia entrada e 3Kg de alimento
                            </h2>
                            <p></p>
                            <div class="opcao-valor">
                    ...
                    <fieldset>
                        <div class="opcao-ingresso">
                            ...
                            <h2>
                                <span class="caps">INTEIRA</span>
                                <br>
                                Mediante doação de 3kg de alimento
                            </h2>
                            <p></p>
                            <div class="opcao-valor">
    ...
    <script src="quandoeuformae.js"></script>
