...
<head>
    ...
    <title>Pai dos Gatos</title>
    <link rel="stylesheet" href="style_paidosgatos2.css">
</head>
...
<body>
    ...
    <div class="flex-container" id="home">
        <div class="pericles">
            <img src="../Fotos/opaidosgatos.png" style="border-radius: 30px !important;" class="mx-auto d-block img-fluid evento"
    ...
    <div class="titulo-info">
        <h1> O PAI DOS GATOS</h1>
        <h4>QUARTA-FEIRA às 18h00 | 15 DE NOVEMBRO</h4>
        <h4> Manguetown Comedy, Recife - PE</h4>
    </div>
    <div class="todas-info principal">
        <div class="col col-esq">
            <div class="info-evento">
                ...
                <h5>Sobre:</h5>
                É ELE, O PAI DOS GATOS!
                <br>
                DE VOLTA NUMA 2° EDIÇÃO, ANDRÉ ASSUNÇÃO RETORNA MAIS UMA VEZ EMBARCANDO NESTA VIAGEM ICÔNICA AO SEU
                CONTIDIANO, MOSTRANDO DE FORMA AUDACIOSA E INUSITADA TODA SUA HISTÓRIA COM OS BICHANOS MAIS FAMOSO E
                AMADOS DO PAÍS: OS GATOS. VAI EMBARCAR NESSA TAMBÉM?
                <br>
                <br>
                📅 DATA: 15 DE SETEMBRO DE 2023 (QUARTA-FEIRA)<br><br>
                ⏰ HORÁRIO: 18H00 <br><br>
                📍 LOCAL: Manguetown Comedy (4880 Avenida Conselheiro Aguiar- RECIFE, PE)
                <br><br>
                <h5>Atrações principais:</h5>
                &bull; ANDRÉ ASSUNÇÃO E CIA <br><br>
                GARANTA SEU LUGAR NESSA FARRA INCRÍVEL! INGRESSOS JÁ À VENDA EM NOSSO SITE OU NOS PONTOS AUTORIZADOS.
                <br><br>
                PREPARE-SE PARA VIVER MOMENTOS INESQUECÍVEIS! MARQUE NA AGENDA E CONVIDE SEUS AMIGOS PARA ESSE STAND
                CHEIO DE IRONIA E DIVERSÃO. ESPERAMOS POR VOCÊ!
                <br><br>
                <h5>Informações Importantes:</h5>
                &bull; Observe atentamente as regras sanitárias do seu evento.
                <br>
                <br>
                &bull; Para acessar o evento, basta apresentar o código QR do seu ingresso ao segurança/porteiro do
                evento.
                ...
                <br>
                <br>
                &bull; Não nos responsabilizamos por ingressos comprados a terceiros, ou seja, use sempre os canais
                oficias
                do evento.
                <br>
                <br>
                ...
                <br>
                <br>
                &bull; O ingresso é um título ao portador. Em caso de roubo, furto ou fenômeno da natureza, não
                reimprimimos
                ingresso.
                <br>
                <br>
                ...
                <div class="box-ingressos">
                    ...
                    <fieldset>
                        <div class="opcao-ingresso">
                            ...
                            <h2>
                                <span class="caps">COUVERT ARTÍSTICO (MEIA)</span>
                                <br>
                                Documento de identificação estudantil válido no momento da entrada
                            </h2>
                            <p></p>
                    ...
                    <fieldset>
                        <div class="opcao-ingresso">
                            ...
                            <span class="caps">COUVERT ARTÍSTICO (INTEIRA)</span>
                            <br>
                            <p></p>
                            <div class="opcao-valor">
                    ...
                    <fieldset>
                        <div class="opcao-ingresso">
                            ...
                            <span class="caps">COUVERT ARTÍSTICO (VIP)</span>
                            <br>
                            <p></p>
                            <div class="opcao-valor">
    ...
    <script src="paidosgatos.js"></script>
