...
<head>
    ...
    <title>Lounge</title>
    <link rel="stylesheet" href="style_lounge2.css">
...
<body>
    ...
    <div class="flex-container" id="home">
        <div class="pericles">
            <img src="../Fotos/bebidarosa.png" style="border-radius: 30px !important;"
    ...
    <div class="titulo-info">
        <h1>BEBIDA ROSA NO LOUNGE - 07/10/2023</h1>
        <h4>Sábado às 22h | 07 de Outubro</h4>
        <h4>Lounge Music - Recife, PE</h4>
    </div>
    <div class="todas-info principal">
        <div class="col col-esq">
            <div class="info-evento">
                ...
                <h5>Sobre:</h5>
                📅 DATA: 07 DE OUTUBRO DE 2023 (SÁBADO) <br><br>
                ⏰ HORÁRIO: 22H00 <br><br>
                📍 LOCAL: AV. BERNARDO VIEIRA DE MELO, 1300 - PIEDADE, JABOATÃO DOS GUARARAPES - PE
                <br>
                <br>
                <h5>Participantes principais:</h5>
                &bull;VULGO FK (Atração Principal)
                <br>
                &bull;MC PH
                <br>
                &bull;VEIGH
                ...
                <br>
                Basta apresentar o código QR do seu ingresso ao segurança/porteiro do evento.
                    ...
                    <fieldset>
                        <div class="opcao-ingresso">
                            <div class="info-header">
                                <span class="info-esq">PRÉ-VENDA</span>
                                <span class="info-dir">Sub Total</span>
                            </div>
                            <h2>
                                <span class="caps">FRONT STAGE</span>
                            </h2>
                            <p></p>
